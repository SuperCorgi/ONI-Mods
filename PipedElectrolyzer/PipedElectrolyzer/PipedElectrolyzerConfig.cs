...
namespace PipedElectrolyzer
{
    public class PipedElectrolyzerConfig : IBuildingConfig
    {
        ...
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
        {
            ...
            {
            new ElementConverter.OutputElement(WATER2OXYGEN_RATIO, SimHashes.Oxygen, OXYGEN_TEMPERATURE, false, true),
            new ElementConverter.OutputElement(0.111999989f, SimHashes.Hydrogen, OXYGEN_TEMPERATURE, false, false, 0f, 1f, 1f, 255, 0)
            };
