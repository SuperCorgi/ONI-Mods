...
namespace MultiIO
{
    public static class PortIconColors
    {
        ...
        public static Color SaltWater = Assets.SubstanceTable.GetSubstance(SimHashes.SaltWater).conduitColour;
        public static Color Brine = Assets.SubstanceTable.GetSubstance(SimHashes.Brine).conduitColour;
    }
